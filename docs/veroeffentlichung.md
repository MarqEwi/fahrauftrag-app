...
| Beschreibung (max. 200) | `Entfernt die Werbung, hebt das Limit von 5 Fahrten in Liste und Nachtrag auf und schaltet die Ausgabe als PDF, Bild oder Text sowie das Drucken frei. Einmaliger Kauf, kein Abo.` |
